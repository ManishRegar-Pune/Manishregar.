...
const SocialMedia = () => {
  const socialLinks = [
    {
      platform: "Instagram",
      username: "@manish_regar_io",
      url: "https://www.instagram.com/manish_regar_io?igsh=MTBiOHM0Z2J2Mm9oZw==",
    ...
    },
    {
      ...
      url: "https://www.snapchat.com/add/manish_regar369?share_id=WYYoRItmSdo&locale=en-IN",
      icon: "fab fa-snapchat",
      description: "Quick updates and tech moments"
    },
    {
      platform: "GitHub",
      username: "@ManishRegar-Pune",
      url: "https://github.com/ManishRegar-Pune",
      icon: "fab fa-github",
